...
void test_case_2() {
    ...
    weight[0] = 5;    value[0] = 20;
    weight[1] = 4;    value[1] = 15;
    weight[2] = 3;    value[2] = 10;
    weight[3] = 2;    value[3] = 8;
...
void test_case_3() {
    ...
    weight[0] = 2;    value[0] = 5;
    weight[1] = 3;    value[1] = 8;
    weight[2] = 5;    value[2] = 12;
    weight[3] = 4;    value[3] = 10;
    weight[4] = 6;    value[4] = 14;
...
void test_case_4() {
    ...
    weight[1] = 7;    value[1] = 15;
    weight[2] = 8;    value[2] = 18;
...
void test_case_5() {
    ...
    weight[0] = 10;   value[0] = 22;
    weight[1] = 20;   value[1] = 44;
    weight[2] = 30;   value[2] = 60;
    weight[3] = 5;    value[3] = 15;
    weight[4] = 15;   value[4] = 35;
    weight[5] = 12;   value[5] = 28;
...
void demonstrate_table_filling() {
    ...
    weight[0] = 5;    value[0] = 10;
    weight[1] = 7;    value[1] = 12;
    weight[2] = 6;    value[2] = 11;
    ...
    for (int w = 1; w <= W; w++) {
        if (weight[0] > w) {
            ...
            dp[1][w] = (value[0] + dp[0][w - weight[0]] > dp[0][w]) ? 
                       value[0] + dp[0][w - weight[0]] : dp[0][w];
        }
    }
    ...
    for (int w = 1; w <= W; w++) {
        if (weight[1] > w) {
            ...
            dp[2][w] = (value[1] + dp[1][w - weight[1]] > dp[1][w]) ? 
                       value[1] + dp[1][w - weight[1]] : dp[1][w];
        }
    }
    ...
    for (int w = 1; w <= W; w++) {
        if (weight[2] > w) {
            ...
            dp[3][w] = (value[2] + dp[2][w - weight[2]] > dp[2][w]) ? 
                       value[2] + dp[2][w - weight[2]] : dp[2][w];
        }
    }
